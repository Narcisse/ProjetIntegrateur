...
public class EcouteurBoutonsPaysan implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        if(((JButton)e.getSource()).getName().equals(PaysanVue.BOUTON_PAYSAN_ATTAQUER)){
            JOptionPane.showMessageDialog(null, "Les paysans attaquent!");
        }
        if(((JButton)e.getSource()).getName().equals(PaysanVue.BOUTON_PAYSAN_ARRETER)){
            JOptionPane.showMessageDialog(null, "Les paysans arretent de bouger!");
        }
        if(((JButton)e.getSource()).getName().equals(PaysanVue.BOUTON_PAYSAN_RECOLTER)){
