...
public class Entrepot {
    ...
    //Setter
    public void setBois(int leBois) {
        this.bois = leBois;
    }

    public void setNourriture(int laNourriture) {
        this.nourriture = laNourriture;
    }

    public void setOr(int lOr) {
        this.or = lOr;
    }
    ...
    public boolean verificationOrNourriture(int lOr, int laNourriture) {
        if (getOr() < lOr || getNourriture() < laNourriture) {
            return false;
        } else {
            return true;
        }
    ...
    public boolean verificationOrBoisNourriture(int lOr, int leBois, int laNourriture) {
        if (getOr() < lOr || getBois() < leBois || getNourriture() < nourriture) {
            return false;
        } else {
            return true;
        }
    ...
    //Bois
    public void ajoutBois(int laRecolte) {
        setBois(getBois() + laRecolte);
    }

    //Nourriture
    public void ajoutNourriture(int laRecolte) {
        setNourriture(getNourriture() + laRecolte);
    }

    //Or
    public void ajoutOr(int laRecolte) {
        setOr(getOr() + laRecolte);
    }
}
